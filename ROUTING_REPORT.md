...
- `12100`: AE2 smart/dense cable inactive channel quads (`channels_00`, `channels_10`).
- `12101`: AE2 smart/dense cable low channel quads (`channels_01..04`).
- `12102`: AE2 smart/dense cable high channel quads (`channels_11..14`).
- `12103`: AE2 ME drive status LED quads.
- `12104`: AE2 terminal light quads, debug-only.
...
- `*terminal_dark`, `*terminal_medium`, `*terminal_bright`, and `fluid_terminal/lights_*` -> `12104` debug-only.
- `*drive_cell_states*` -> `12103`.
- `parts/cable/smart/channels_00` or `channels_10` -> `12100`.
- `parts/cable/smart/channels_01..04` -> `12101`.
- `parts/cable/smart/channels_11..14` -> `12102`.
- `parts/cable/dense_smart/channels_00` or `channels_10` -> `12100`.
- `parts/cable/dense_smart/channels_01..04` -> `12101`.
- `parts/cable/dense_smart/channels_11..14` -> `12102`.

5-8 channel states should produce both `12101` and `12102` because AE2 emits the odd/even channel layers as separate quads.
...
`GTShaderBridge: semantic route detected, source=BakedQuad, materialId=..., sprite=...`

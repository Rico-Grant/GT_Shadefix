...
public final class GTShaderBridge {
    ...
    public static final String VERSION = "1.5.0-multiroute-debug";
    public static final Logger LOGGER = LogManager.getLogger(MODID);

    @Mod.EventHandler
    public void preInit(FMLPreInitializationEvent event) {
        GTShaderBridgeConfig.load(event.getModConfigurationDirectory());
        LOGGER.info("[GTShaderBridge] Buffer-bound CCL multi-route entity-data bridge loaded; enabled={}, writeEntityData={}, machine={}, pipe={}, cable={}",

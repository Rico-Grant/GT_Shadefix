...
public final class BakedQuadShaderRouter {
    ...
    private static boolean shouldUseOcGenericEmission(String iconName) {
        return iconName.contains("blocks/printer_")
            ...
            || iconName.contains("blocks/assembler_")
            || iconName.contains("blocks/diskdrive_front")
            || iconName.contains("blocks/netsplitter_")
            || iconName.contains("blocks/powerdistributor_")
            || iconName.contains("blocks/redstone_")
            || iconName.contains("blocks/switch_")
            || iconName.contains("blocks/motionsensor_")
            || iconName.contains("blocks/overlay/assembler_")
            ...
            || iconName.contains("blocks/overlay/netsplitter_")
